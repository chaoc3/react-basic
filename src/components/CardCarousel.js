...
import card1 from '../assets/卡片/正面/User-1-1.png'; // 导入卡片1
import card2 from '../assets/卡片/正面/User-2-1.png'; // 导入卡片2
import NextArrowImg from '../assets/网页素材/向右.svg'; // 导入右箭头
import PrevArrowImg from '../assets/网页素材/向左.svg'; // 导入左箭头
